...
\cliente{Lautaro Gonzalez}
\empresaCliente{Empresa lider de consumo masivo}
...
%Presupuesto: Sueldo (Hora Hombre * 600hs) + Clusters + Compu = 

Por medio de la presente se acuerda con el \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'' y consistirá en el diseño, desarrollo e integración de un sistema de recomendación basado en afinidad cliente-producto, que estima el interés potencial de cada cliente por cada producto del portafolio de la empresa. El trabajo tendrá un presupuesto preliminar estimado de 600 horas y un costo estimado de \$ 13.500.000, con fecha de inicio el \fechaInicioName\hspace{1px} y fecha de presentación pública el \fechaFinalName.
